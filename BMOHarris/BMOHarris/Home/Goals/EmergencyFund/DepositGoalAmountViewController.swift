//
//  DepositGoalAmountViewController.swift
//  BMO
//
...
class DepositGoalAmountViewController: UIViewController {
  ...
  func addTableView() {
    ...
    tableView.register(GoalAmountDepositCell.nib, forCellReuseIdentifier: GoalAmountDepositCell.identifier)
...
extension DepositGoalAmountViewController: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    let cell = tableView.dequeueReusableCell(withIdentifier: GoalAmountDepositCell.identifier, for: indexPath) as! GoalAmountDepositCell
  ...
  func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    let controller = GoalCompletedViewController()
