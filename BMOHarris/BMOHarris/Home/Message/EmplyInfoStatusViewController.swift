//
//  EmplyInfoStatusViewController.swift
//  BMO
//
...
class EmplyInfoStatusViewController: UIViewController {
  ...
  @objc func showMwessageTYpe(){
    ...
    uploadstatusView?.describtionLabe2.text = "info for verification"
  ...
  @objc func showMwessageTYpe2() {
    ...
    successStatusMsgView?.titleLabel2.text = "You have to upload ID &\naddress proof"
    ...
    successStatusMsgView?.heightAnchor.constraint(equalToConstant: 180).isActive = true
...
//    view.addSubview(spinner)
  ...
  @objc func movetoOtherScreen2() {
    ...
    let controller = UploadProofIdentityViewController()
